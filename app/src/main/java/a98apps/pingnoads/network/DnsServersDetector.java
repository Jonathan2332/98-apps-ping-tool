 ...
 *
 * Created by Madalin Grigore-Enescu on 2/24/18.
 * Adapted by 98 Corporation, Swish CEO 98 Apps.
 */
...
class DnsServersDetector {
     ...
     * Constructor
     */
    DnsServersDetector(Context context) {
                ...
                if (connectivityManager != null) {
                    ...
                    for (Network network : connectivityManager.getAllNetworks()) {
                        ...
                        if (networkInfo.isConnected()) {
                            ...
                            if(linkProperties.getInterfaceName() != null && linkProperties.getInterfaceName().contains("0") && networkInfo.getType() != ConnectivityManager.TYPE_WIFI) {//mobile only
                                thisConnection = true;
                    ...
                    if(!thisConnection)//Se a conexão do usuário não estiver com nenhuma conexão terminado com 0, verificará a próxima
                    {
                        for (Network network : connectivityManager.getAllNetworks())
                        {
                            NetworkInfo networkInfo = connectivityManager.getNetworkInfo(network);
    ...
    private String [] getServersMethodExec() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            try {
                ProcessBuilder builder = new ProcessBuilder("getprop");
