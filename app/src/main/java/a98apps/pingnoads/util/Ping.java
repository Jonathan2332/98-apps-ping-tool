...
public class Ping extends Thread {
    ...
    private PingStream terminalInput;
    ...
    private void setViewHolder(ViewHolder mViewHolder) {
    ...
    public Ping(Activity activity, String url, ViewHolder v, SecurityPreferences security, TabPing tab)
    {
        ...
        try
        {
            ...
            if(commands != null)
            {
                if(proc == null)
                {
                    ...
                    terminalInput = new PingStream(proc.getInputStream(), getActivity(), mSecurityPreferences, mViewHolder, listPing, this);
    ...
    void stopResult(final String text)
    {
        if(text != null)
        {
            if(mViewHolder.buttonPing.getText().equals(getActivity().getString(R.string.parar)))
            {
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        listPing.addItems(text);
